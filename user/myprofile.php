	...
	<div class="container">
		...
		<div class="panel panel-info">
			<div class="panel-body">
				<br />
				<b><h6 id="pg_title">USER PROFILE</h6></b>
				<hr>
			</div>
		</div>
	
		<ul class = "nav nav-pills">
			<li style="margin-right: 18px;" class = "active"><a href = "home.php"><i class="fa fa-sign-out"></i> Go Back</a></li>			
		</ul>	
		...
		<div class="card border-info">
			...
			<div class="card-body text-info">
				<div class="row">
					...
					<div class="col-md-6">
						<img src="../images/profile.png" style="margin-left: 180px; margin-top: 45px" alt="Profile Picture"/>
