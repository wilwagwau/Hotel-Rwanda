...
<body>
	...
	<div class="containe" style="margin-left: 25px; margin-right:25px;">
        ...
        <div class="card border-info">
			<div class="card-header">Checked In Reservations</div>
			...
			<div class="card-body text-info">
				<ul class = "nav nav-pills">
					...
					<li style="margin-right: 12px;" >
						<a class="btn btn-sm btn-success disabled" href = "#"> <span class = "badge" style="font-size: 15px;"><?php echo $f_ci['total']?></span> Checked In</a>
					</li>
					<li style="margin-right: 12px;" >
						...
						<table id = "table" class = "table table-bordered table-responsive-sm table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<center>
											<a class = "btn btn-sm btn-outline-warning" onclick = "confirmationCheckout(<?php echo $fetch['transaction_id']?>); return false;" href = "checkout_query.php?transaction_id=<?php echo $fetch['transaction_id']?>"><i class = "fa fa-check"></i> Check Out</a>	
										</center>
										<script type="text/javascript">
											//Checkout a guest
											function confirmationCheckout(userid)
											{
											if(confirm("Do you want to checkout this guest ?"))
												{
													window.location.href='checkout_query.php?transaction_id='+transaction_id;
													return true;
												}
											}
										</script>
